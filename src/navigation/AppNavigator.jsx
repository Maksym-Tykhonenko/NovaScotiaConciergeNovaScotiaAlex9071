...
export default function AppNavigator({ initialUrl, initialId, initialUrlToOurBack,oneSignKkkk }) {
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        <Stack.Screen name="AppNavigatorFlow" component={AppNavigatorFlow} />
      </Stack.Navigator>
    );
  };
...
function MainShell() {
  ...
  const [diningView, setDiningView] = useState('menu');
  const [assistView, setAssistView] = useState('list');
